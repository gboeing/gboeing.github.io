...
[OSMnx]({{ "/2016/11/osmnx-python-street-networks/" | relative_url }}) is a Python
[package](https://github.com/gboeing/osmnx) for easily downloading and analyzing
street networks anywhere in the world. Among other analyses, we can use it to
explore street network orientation. That is, what are the bearings and spatial
orientations of the streets in the network? All of the code for this example is
in this
[GitHub notebook](https://github.com/gboeing/osmnx-examples/blob/v0.11/notebooks/15-calculate-visualize-edge-bearings.ipynb).
First we use OSMnx to download the street network of Moraga, California, a small
town in the hills just east of Berkeley:

![Moraga, California street network OSMnx OpenStreetMap Python]({{ "/files/img/moraga-california-street-network-osmnx-870x1024.png" | relative_url }})
...
OpenStreetMap Python]({{ "/files/img/moraga-california-street-network-polar-plot-1000x1024.png" | relative_url }})
...
![Santa Monica, California street network OSMnx OpenStreetMap Python]({{ "/files/img/santa-monica-california-street-network-osmnx-1024x877.png" | relative_url }})
...
OSMnx OpenStreetMap Python]({{ "/files/img/santa-monica-california-street-network-polar-plot-1000x1024.png" | relative_url }})
...
read this [overview of OSMnx]({{ "/2016/11/osmnx-python-street-networks/" | relative_url }}), or get OSMnx
