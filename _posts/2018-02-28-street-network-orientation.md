...
}}/2016/11/osmnx-python-street-networks/) is a Python
...
![Moraga, California street network OSMnx OpenStreetMap Python]({{ site.url
}}{{ site.baseurl
}}/files/img/moraga-california-street-network-osmnx-870x1024.png)
