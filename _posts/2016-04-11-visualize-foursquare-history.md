...
matplotlib, and basemap. The code is available in this
[GitHub repo](https://github.com/gboeing/data-visualization/blob/master/location-history/foursquare-location-history.ipynb).
It's easy to re-purpose to visualize your own check-in history: you just need to
plug in your Foursquare OAuth token then run the notebook.
...
[Kavrayskiy](https://xkcd.com/977/) projection). So, most of my Foursquare/Swarm
