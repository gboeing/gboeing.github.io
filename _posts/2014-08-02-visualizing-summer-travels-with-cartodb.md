...
_This post is [part of a series][6] on visualizing data from my summer travels._

I [recently discussed][3] OpenPaths and my goals in visualizing location data
from my summer travels. In this post, I'll explore visualizing this dataset with
[CartoDB][1]. The OpenPaths data from my summer travels, which I'll be working
with in these examples, is [available here][2] and I discuss how I
[reverse-geocoded it here][4]. CartoDB is a simple cloud-based tool for building
web maps. You can import data through their web-based dashboard and quickly turn
...
[6]: {{ "/2014/08/visualizing-summer-travels/" | relative_url }}
