...
date: 2025-09-29 12:35:31.000000000 -07:00
permalink: /2025/09/universal-model-street-networks/
---

Marc Barthelemy and I have a new article out in _Physical Review Letters_
titled "[Universal Model of Urban Street
Networks](https://doi.org/10.1103/1vj4-n8vn)" (because PRL apparently doesn't
...
> Analyzing 9000 urban areas' street networks, we identify properties,
...
> parsimonious, generative model based on a two-step mechanism that begins
> with a spanning tree as a backbone then iteratively adds edges to match
> empirical degree distributions. Controlled by a single parameter
> representing lattice-equivalent node density, it accurately reproduces key
> universal properties to bridge the gap between empirical observations and
> generative models.
