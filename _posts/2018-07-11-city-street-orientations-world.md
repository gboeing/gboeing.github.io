...
By popular request, this is a quick follow-up to [this post]({{ site.url }}{{
site.baseurl }}/2018/07/comparing-city-street-orientations/) comparing the
orientation of streets in 25 US cities using Python and [OSMnx]({{ site.url
