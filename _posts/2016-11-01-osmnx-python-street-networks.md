...
_If you use OSMnx in your work, please cite the [journal article][33]._

_Note that this blog post is not updated with every new release of OSMnx. For
the latest, see the official [documentation][5] and usage [examples][2]._

[OSMnx][1] is a Python package to retrieve, model, analyze, and visualize street
networks from OpenStreetMap. Users can download and model walkable, drivable, or
...
bearings/orientations, and network routing. If you use OSMnx in your work,
please download/cite the [paper here][33].
...
![OSMnx: Modena Italy networkx street network in Python from OpenStreetMap][21]

## Installing OSMnx

OSMnx is [on GitHub][1] and you can [install it][4] with conda. If you're
interested in OSMnx but don't know where to begin, check out this guide to
[getting started with Python][8].

## OSMnx features

Check out the [documentation][5] and usage [examples][2] for details on using
...
There are many usage examples and tutorials in the [examples repo][2]. I'll
demonstrate 5 basic use cases for OSMnx in this post:
...
![OSMnx Berkeley city boundaries from OpenStreetMap][16]
...
![OSMnx: Botswana, Zambia, Zimbabwe national borders from OpenStreetMap][32]
...
![OSMnx: San Francisco street network in Python from OpenStreetMap][27]
...
![OSMnx: San Francisco street network in Python from OpenStreetMap][28]
...
![OSMnx: New York street network in Python from OpenStreetMap][18]
...
![OSMnx: Los Angeles street network in Python from OpenStreetMap][19]
...
![OSMnx: Silicon Valley street network in Python from OpenStreetMap][29]
...
Note: you can also [topologically consolidate][10] nearby intersections.
...
![OSMnx: Arizona suburb before simplifying - networkx street network in Python
...
![QGIS: New York street network from OpenStreetMap][22]
...
[example][3]) to contrast shortest paths by distance (red) vs by travel time
(blue):

![Calculate shortest path routes that minimize distance or travel time by
imputing missing street speeds with OSMnx][24]

You can also visualize the compass [orientation][9] of street networks around
the world:

![City street network grid orientations, order, disorder, entropy, rose plot,
polar histogram made with Python, OSMnx, OpenStreetMap, matplotlib.][17]
...
We can [re-create this][7] automatically and computationally with OSMnx:

![OSMnx: Figure-ground diagrams of one square mile of each street network, from
OpenStreetMap, made in Python with matplotlib, geopandas, and NetworkX][30]
...
queries][6] with r-tree, kd-tree, and ball-tree indexes.
...
[4]: https://osmnx.readthedocs.io/en/stable/#installation
[5]: https://osmnx.readthedocs.org
[6]: {{ "/2016/10/r-tree-spatial-index-python/" | relative_url }}
[7]: {{ "/2017/01/square-mile-street-network-visualization/" | relative_url }}
[8]: {{ "/2017/02/python-getting-started/" | relative_url }}
[9]: {{ "/2019/09/urban-street-network-orientation/" | relative_url }}
[10]: {{ "/2020/06/whats-new-with-osmnx/" | relative_url }}
[11]: {{ "/files/img/az-simplify-all.png" | relative_url }}
[12]: {{ "/files/img/az-simplify-both.png" | relative_url }}
[13]: {{ "/files/img/az-simplify-non-strict.png" | relative_url }}
[14]: {{ "/files/img/az-simplify-strict.png" | relative_url }}
[15]: {{ "/files/img/belgrade-serbia-street-network-254x300.png" | relative_url }}
[16]: {{ "/files/img/berkeley-city-boundaries-300x209.png" | relative_url }}
[17]: {{ "/files/img/city-street-network-polar-histograms-alpha-273x300.jpg" | relative_url }}
[18]: {{ "/files/img/empire-state-network-address-300x291.png" | relative_url }}
[19]: {{ "/files/img/los-angeles-street-network-907x1024.png" | relative_url }}
[20]: {{ "/files/img/maputo-mozambique-street-network-300x229.png" | relative_url }}
[21]: {{ "/files/img/modena-italy-street-network-300x283.png" | relative_url }}
[22]: {{ "/files/img/new-york-street-network-qgis-1024x555.png" | relative_url }}
[23]: {{ "/files/img/osmnx-route-distance.png" | relative_url }}
[24]: {{ "/files/img/osmnx-route-travel-time.png" | relative_url }}
[25]: {{ "/files/img/piedmont-california-street-network-illustrator-svg-1024x614.jpg" | relative_url }}
[26]: {{ "/files/img/sf-mission-street-network-264x300.png" | relative_url }}
[27]: {{ "/files/img/sf-street-network-bbox-300x183.png" | relative_url }}
[28]: {{ "/files/img/sf-street-network-point-284x300.png" | relative_url }}
[29]: {{ "/files/img/silicon-valley-street-network-300x248.png" | relative_url }}
[30]: {{ "/files/img/square-mile-street-networks-1024x822.jpg" | relative_url }}
[31]: {{ "/files/img/tunis-tunisia-street-network-300x282.png" | relative_url }}
[32]: {{ "/files/img/zambia-zimbabwe-botswana-borders-264x300.png" | relative_url }}
[33]: {{ "/publications/osmnx-paper/" | relative_url }}
