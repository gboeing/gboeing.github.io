...
_If you use OSMnx in your work, please cite the [journal article]({{ "/publications/osmnx-paper/" | relative_url }})._
...
OSMnx in your work, please download/cite the [paper here]({{ "/publications/osmnx-paper/" | relative_url }}).
...
![OSMnx: Modena Italy networkx street network in Python from OpenStreetMap]({{ "/files/img/modena-italy-street-network-300x283.png" | relative_url }})
...
guide to [getting started with Python]({{ "/2017/02/python-getting-started/" | relative_url }}).
...
![OSMnx Berkeley city boundaries from OpenStreetMap]({{ "/files/img/berkeley-city-boundaries-300x209.png" | relative_url }})
...
![OSMnx: Botswana, Zambia, Zimbabwe national borders from OpenStreetMap]({{ "/files/img/zambia-zimbabwe-botswana-borders-264x300.png" | relative_url }})
...
![OSMnx: San Francisco street network in Python from OpenStreetMap]({{ "/files/img/sf-street-network-bbox-300x183.png" | relative_url }})
...
![OSMnx: San Francisco street network in Python from OpenStreetMap]({{ "/files/img/sf-street-network-point-284x300.png" | relative_url }})
...
![OSMnx: New York street network in Python from OpenStreetMap]({{ "/files/img/empire-state-network-address-300x291.png" | relative_url }})
...
OpenStreetMap]({{ "/files/img/sf-mission-street-network-264x300.png" | relative_url }})
...
![OSMnx: Los Angeles street network in Python from OpenStreetMap]({{ "/files/img/los-angeles-street-network-907x1024.png" | relative_url }})
...
![OSMnx: Silicon Valley street network in Python from OpenStreetMap]({{ "/files/img/silicon-valley-street-network-300x248.png" | relative_url }})
...
OpenStreetMap]({{ "/files/img/belgrade-serbia-street-network-254x300.png" | relative_url }})
...
OpenStreetMap]({{ "/files/img/maputo-mozambique-street-network-300x229.png" | relative_url }})
...
OpenStreetMap]({{ "/files/img/tunis-tunisia-street-network-300x282.png" | relative_url }})

### 3. Correct and simplify network topology

Note: you can also [topologically consolidate]({{ "/2020/06/whats-new-with-osmnx/" | relative_url }}) nearby intersections.
...
from OpenStreetMap]({{ "/files/img/az-simplify-all.png" | relative_url }})
...
![OSMnx: Arizona suburb before simplifying - networkx street network in Python
from OpenStreetMap]({{ "/files/img/az-simplify-both.png" | relative_url }})
...
from OpenStreetMap]({{ "/files/img/az-simplify-strict.png" | relative_url }})
...
![OSMnx: Arizona suburb after simplifying - networkx street network in Python
from OpenStreetMap]({{ "/files/img/az-simplify-non-strict.png" | relative_url }})
...
![QGIS: New York street network from OpenStreetMap]({{ "/files/img/new-york-street-network-qgis-1024x555.png" | relative_url }})
...
OpenStreetMap]({{ "/files/img/piedmont-california-street-network-illustrator-svg-1024x614.jpg" | relative_url }})
...
![OSMnx: routing along a street network with networkx and OpenStreetMap]({{ "/files/img/osmnx-route-distance.png" | relative_url }})
...
You can also visualize the compass [orientation]({{ "/2019/09/urban-street-network-orientation/" | relative_url }}) of street networks around the
world:

![City street network grid orientations, order, disorder, entropy, rose plot,
polar histogram made with Python, OSMnx, OpenStreetMap, matplotlib.]({{ "/files/img/city-street-network-polar-histograms-alpha-273x300.jpg" | relative_url }})
...
We can [re-create this]({{ "/2017/01/square-mile-street-network-visualization/" | relative_url }}) automatically and
...
queries]({{ "/2016/10/r-tree-spatial-index-python/" | relative_url }})
with r-tree, kd-tree, and ball-tree indexes.

OSMnx is open-source and [on GitHub](https://github.com/gboeing/osmnx). You can
download/cite the [paper here]({{ "/publications/osmnx-paper/" | relative_url }}).
