...
We can calculate this easily with [OSMnx]({{ "/2016/11/osmnx-python-street-networks/" | relative_url }}), as seen in this
...
![Urban street network graph node closeness and betweenness centrality]({{ "/files/img/urban-street-network-graph-node-closeness-centrality-1024x666.png" | relative_url }})
...
![Urban street network graph edge closeness and betweenness centrality]({{ "/files/img/urban-street-network-graph-edge-closeness-centrality-1024x666.png" | relative_url }})
...
measures. For more info about OSMnx check out this [journal article]({{ "/publications/osmnx-complex-street-networks/" | relative_url }}), this
[blog post]({{ "/2016/11/osmnx-python-street-networks/" | relative_url }}), or its
