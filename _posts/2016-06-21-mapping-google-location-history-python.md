...
I recently wrote about visualizing my [Foursquare check-in history]({{ "/2016/04/visualize-foursquare-history/" | relative_url }}) and it
...
![Map of my Google location history data worldwide, 2012-2016]({{ "/files/img/google_location_history_world_map-1024x627.png" | relative_url }})
...
matplotlib basemap]({{ "/files/img/google_location_history_cal_map-831x1024.png" | relative_url }})
...
Northern California, made with Python matplotlib basemap]({{ "/files/img/google_location_history_sf_bay_map-1-831x1024.png" | relative_url }})
...
might also be interested in [mapping everywhere you've ever been]({{ "/2016/06/mapping-everywhere-ever-been/" | relative_url }}), analyzing your
[Foursquare check-in history]({{ "/2016/04/visualize-foursquare-history/" | relative_url }}), or our [course at UC Berkeley]({{ "/2015/08/urban-informatics-visualization-berkeley/" | relative_url }})
