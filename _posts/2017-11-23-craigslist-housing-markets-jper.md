...
date: 2017-11-23 14:03:02-08:00
...
Journal of Planning Education and Research.]({{ "/files/img/01-craigslist-rental-housing-listings-us-map-1024x677.jpg" | relative_url }})

Here are 4 [key takeaways]({{ "/2016/08/craigslist-rental-housing-insights/" | relative_url }}):
...
1. There are incredibly few rental units below fair market rent in the hottest
   ...
   single-digit percentages of Craigslist rental listings below fair market
   rent. That's really low.
1. This problem doesn't exclusively affect the poor: the share of its income
   that the typical household would spend on the typical rent in cities like New
   York and San Francisco exceeds the threshold for "rent burden."
...
> activity or the full scope of the US rental market. To address this gap, we
> collected, cleaned, analyzed, mapped, and visualized eleven million Craigslist
> rental housing listings. The data reveal fine-grained spatial and temporal
> patterns within and across metropolitan housing markets in the United States.
> We find that some metropolitan areas have only single-digit percentages of
> listings below fair market rent. Nontraditional sources of volunteered
> geographic information offer planners real-time, local-scale estimates of rent
> and housing characteristics currently lacking in alternative sources, such as
> census data.

For more info on this project and the findings from analyzing Craigslist housing
markets, check out this summary [blog post]({{ "/2016/08/craigslist-rental-housing-insights/" | relative_url }}) or download the JPER [journal
article]({{ "/publications/craigslist-rental-housing-markets/" | relative_url }}). Also see this analysis of
[census rents]({{ "/2015/11/landscape-us-rents/" | relative_url }})
data.
