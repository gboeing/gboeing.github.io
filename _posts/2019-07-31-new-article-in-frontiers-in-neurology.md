...
Tools, Data, and Services for Geospatial Analysis of Stroke Services][3], that
has been accepted for publication at _Frontiers in Neurology_ ([download free
PDF][3]).
...
demonstrated in R and Python (including [OSMnx][1]), and features static mapping
