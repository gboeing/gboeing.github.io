...
1. Download and process my [Foursquare/Swarm check-in history]({{ site.url
   }}{{ site.baseurl }}/2016/04/visualize-foursquare-history/)
1. Download my [Google location history]({{ site.url }}{{ site.baseurl
   }}/2016/06/mapping-google-location-history-python/) from their Takeout site
1. [Cluster]({{ site.url }}{{ site.baseurl
   }}/2014/08/clustering-to-reduce-spatial-data-set-size/) my Google location
   data set to reduce its size (for Leaflet)
1. [Reverse-geocode]({{ site.url }}{{ site.baseurl
...
post]({{ site.url }}{{ site.baseurl }}/2016/04/visualize-foursquare-history/).
...
in its entirety with Python, as I describe in [this post]({{ site.url }}{{
site.baseurl }}/2016/06/mapping-google-location-history-python/). I mapped my
...
data in the San Francisco Bay Area, 2012-2016]({{ site.url }}{{ site.baseurl
...
- Simply mapping your [Google location history]({{ site.url }}{{ site.baseurl
  }}/2016/06/mapping-google-location-history-python/) with Python
- Visualizing and mapping your [Foursquare check-in history]({{ site.url }}{{
  site.baseurl }}/2016/04/visualize-foursquare-history/)
- [Clustering to reduce]({{ site.url }}{{ site.baseurl
  }}/2014/08/clustering-to-reduce-spatial-data-set-size/) spatial data set size
- [Reverse-geocoding]({{ site.url }}{{ site.baseurl
  }}/2014/08/reverse-geocode-a-set-of-lat-long-coordinates-to-city-country/)
