...
This post is adapted from this [research paper]({{ "/2019/09/urban-street-network-orientation/" | relative_url }}) that you can read/cite for more
...
urban navigation? I recently wrote about visualizing street [orientations]({{ "/2018/02/street-network-orientation/" | relative_url }}) with Python
and [OSMnx]({{ "/2018/03/osmnx-features-roundup/" | relative_url }}).
...
[follow- up]({{ "/2019/09/urban-street-network-orientation/" | relative_url }}) comparing world cities):
...
DC.]({{ "/files/img/city-street-orientations-usa-osmnx-930x1024.png" | relative_url }})
...
OpenStreetMap mapped with OSMnx and Python]({{ "/files/img/manhattan-nyc-street-network-bearings-osmnx-646x1024.png" | relative_url }})
...
OpenStreetMap mapped with OSMnx and Python]({{ "/files/img/detroit-michigan-street-bearings-osmnx.jpg" | relative_url }})
...
OpenStreetMap mapped with OSMnx and Python]({{ "/files/img/boston-massachusetts-street-network-bearings-osmnx-864x1024.png" | relative_url }})
...
_Want to see more cities?_ This post is adapted from this [research paper]({{ "/2019/09/urban-street-network-orientation/" | relative_url }}) that
analyzes and visualizes [100 cities]({{ "/2019/09/urban-street-network-orientation/" | relative_url }}) around the world, discussing these
methods, entropy calculations, and images in more detail. And for more on OSMnx,
see this [post]({{ "/2018/03/osmnx-features-roundup/" | relative_url }}) or this
...
up]({{ "/2019/09/urban-street-network-orientation/" | relative_url }})
...
Tehran, Toronto, Warsaw, Tokyo, Berlin, Venice]({{ "/files/img/city-street-orientations-world-osmnx-272x300.png" | relative_url }})
